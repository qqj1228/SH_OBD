        ...
        private void RefreshDisplay() {
            ...
            try {
                if (m_ListDTC.Count > 0) {
                    for (int i = 1; i <= m_ListDTC.Count; i++) {
                        DTC dtc = m_ListDTC[i - 1];
                ...
                if (m_ListPending.Count > 0) {
                    for (int i = 1; i <= m_ListPending.Count; i++) {
                        DTC dtc = m_ListPending[i - 1];
                ...
                if (m_ListPermanent.Count > 0) {
                    for (int i = 1; i <= m_ListPermanent.Count; i++) {
                        DTC dtc = (DTC)m_ListPermanent[i - 1];

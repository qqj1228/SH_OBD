...
namespace SH_OBD {
    public class O2TestResultsControl : UserControl {
        ...
        protected override void Dispose([MarshalAs(UnmanagedType.U1)] bool disposing) {
            lblTestIDHeader.Dispose();
            lblDescriptionHeader.Dispose();
            lblValueHeader.Dispose();
            lblMinimumHeader.Dispose();
            lblMaximumHeader.Dispose();
            lblUnitsHeader.Dispose();
            lblTestID01.Dispose();
            lblDescription01.Dispose();
            lblTestID02.Dispose();
            lblUnits01.Dispose();
            lblMaximum01.Dispose();
            lblMinimum01.Dispose();
            lblValue01.Dispose();
            lblUnits02.Dispose();
            lblMaximum02.Dispose();
            lblMinimum02.Dispose();
            lblValue02.Dispose();
            lblDescription02.Dispose();
            lblUnits04.Dispose();
            lblMaximum04.Dispose();
            lblMinimum04.Dispose();
            lblValue04.Dispose();
            lblDescription04.Dispose();
            lblTestID04.Dispose();
            lblUnits03.Dispose();
            lblMaximum03.Dispose();
            lblMinimum03.Dispose();
            lblValue03.Dispose();
            lblDescription03.Dispose();
            lblTestID03.Dispose();
            lblUnits08.Dispose();
            lblMaximum08.Dispose();
            lblMinimum08.Dispose();
            lblValue08.Dispose();
            lblDescription08.Dispose();
            lblTestID08.Dispose();
            lblUnits07.Dispose();
            lblMaximum07.Dispose();
            lblMinimum07.Dispose();
            lblValue07.Dispose();
            lblDescription07.Dispose();
            lblTestID07.Dispose();
            lblUnits06.Dispose();
            lblMaximum06.Dispose();
            lblMinimum06.Dispose();
            lblValue06.Dispose();
            lblDescription06.Dispose();
            lblTestID06.Dispose();
            lblUnits05.Dispose();
            lblMaximum05.Dispose();
            lblMinimum05.Dispose();
            lblValue05.Dispose();
            lblDescription05.Dispose();
            lblTestID05.Dispose();
            lblUnits0A.Dispose();
            lblMaximum0A.Dispose();
            lblMinimum0A.Dispose();
            lblValue0A.Dispose();
            lblDescription0A.Dispose();
            lblTestID0A.Dispose();
            lblUnits09.Dispose();
            lblMaximum09.Dispose();
            lblMinimum09.Dispose();
            lblValue09.Dispose();
            lblDescription09.Dispose();
            lblTestID09.Dispose();
        ...
        private void InitializeComponent() {
            ...
            this.lblTestIDHeader.Text = "测试ID";
            ...
            this.lblDescriptionHeader.Text = "测试内容描述";
            ...
            this.lblMinimumHeader.Text = "最小值";
            ...
            this.lblMaximumHeader.Text = "最大值";
            ...
            this.lblDescription01.Text = "混合气富油至贫油传感器阈值电压(常量)";
            ...
            this.lblDescription02.Text = "混合气贫油至富油传感器阈值电压(常量)";
            ...
            this.lblDescription04.Text = "进行切换时间计算的传感器高电压(常量)";
            ...
            this.lblDescription03.Text = "进行切换时间计算的传感器低电压(常量)";
            ...
            this.lblDescription08.Text = "测试周期内的传感器最大电压(计算值)";
            ...
            this.lblDescription07.Text = "测试周期内的传感器最小电压(计算值)";
            ...
            this.lblDescription06.Text = "混合气从贫油至富油传感器切换时间(计算值)";
            ...
            this.lblDescription05.Text = "混合气从富油至贫油传感器切换时间(计算值)";
            ...
            this.lblDescription0A.Text = "传感器周期(计算值)";
            ...
            this.lblDescription09.Text = "传感器间过渡时间(计算值)";
